...
\begin{table}
\caption{CF Performance on Estimating CATEs for Covariates Responsible/Not Responsible for Treatment Effect Heterogeneity in Baseline Model \\ (Sample Size 30000)}
\centering
\resizebox*{\textwidth}{!}{
...
\begin{figure}[!htp]
\caption{CATE Estimates by Variation in Degrees of Heterogeneity}
	\centering
	\begin{subfigure} [h] {0.49\linewidth}
