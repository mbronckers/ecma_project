...
which overlap is violated. Again, it is important to note that the violation of overlap
...
An interesting extension would be looking into the performane of CF under a larger amount 
of overlap violation and how behavior changes under varying degrees of overlap
violation.\\ 
...
data in section 2 are in alignment with the condition under which CF yields
